			...
			wrapper.add = function (svgGroupWrapper) {
				...
				if (svgGroupWrapper) {
					...
					if (!htmlGroup) {
						...
						each(parents.reverse_lazy(), function (parentGroup) {
							var htmlGroupStyle;
	...
	getOffset: function () {
		...
		if (hasData || axis.isLinked) {
			...
			if (axis.horiz && !axis.staggerLines && maxStaggerLines && !labelOptions.rotation) {
				sortedPositions = axis.reversed ? [].concat(tickPositions).reverse_lazy() : tickPositions;
